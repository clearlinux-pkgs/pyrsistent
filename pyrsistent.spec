...
%prep
%setup -q -n pyrsistent-0.16.0
cd %{_builddir}/pyrsistent-0.16.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585148143
...
cp %{_builddir}/pyrsistent-0.16.0/LICENCE.mit %{buildroot}/usr/share/package-licenses/pyrsistent/7c2cc2d536dfd9c7f5fa73b1814db5a6df797aa7
