...
Source0  : https://files.pythonhosted.org/packages/29/04/14e4b9f699222e671aff41460adcc6f67d8e8b68d03cbd278b11feddc496/pyrsistent-0.17.0.tar.gz
...
%prep
%setup -q -n pyrsistent-0.17.0
cd %{_builddir}/pyrsistent-0.17.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599606097
...
cp %{_builddir}/pyrsistent-0.17.0/LICENCE.mit %{buildroot}/usr/share/package-licenses/pyrsistent/7c2cc2d536dfd9c7f5fa73b1814db5a6df797aa7
