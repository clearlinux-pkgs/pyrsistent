...
%prep
%setup -q -n pyrsistent-0.15.7
cd %{_builddir}/pyrsistent-0.15.7
%patch1 -p1
...
cp %{_builddir}/pyrsistent-0.15.7/LICENCE.mit %{buildroot}/usr/share/package-licenses/pyrsistent/7c2cc2d536dfd9c7f5fa73b1814db5a6df797aa7
